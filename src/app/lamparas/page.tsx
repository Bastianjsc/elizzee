...
export default function LamparasPage() {
  ...
  let filteredProducts = LAMPARAS_DATA.filter((product: Lampara) => {
  ...
  return (
    <div className="min-h-screen bg-white w-full text-black">
      <div className="pt-12 pb-24 px-6 md:px-12 max-w-[1440px] mx-auto">
        ...
        {/* Componente de filtros súper limpio, solo con lo necesario */}
        <FiltrosProductos
